// Ported from dreamteam-projections. Premium "product shot" chrome
// wrapping a real, live slice of the tool UI - deliberately NOT a
// screenshot. Every child passed in is the actual component the real page
// renders, reading the same real data, so the preview never drifts out of
// date the way a static image would.
